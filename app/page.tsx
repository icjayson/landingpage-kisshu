      ...
      <section id="products" className="bg-[#F8E4EF] py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-5 max-lg:grid-cols-3 max-md:grid-cols-1 gap-4">
            {/* Kẹo hương dâu */}
            <div className="group overflow-hidden rounded-[16px] border-2 border-[#F0768E] bg-[#F8E4EF] p-4 transition-all hover:shadow-lg">
              <div className="aspect-square w-full max-md:w-3/4 mx-auto">
                <img src="/huong-dau.png" alt="Kẹo hương dâu" className="h-full w-full object-contain" />
              </div>
              <div className="mt-4 text-center">
                <h3 className="text-[20px] font-bold text-[#F0768E]">Kẹo ngậm Kisshu<br />hương dâu</h3>
                <p className="mt-2 text-[14px] text-gray-600">Thưởng thức hương vị dâu tây tự nhiên, ngọt ngào và tươi mát với kẹo ngậm Kisshu hương dâu.</p>
                <button
                  ...
                  className="mt-4 w-full rounded-[8px] bg-[#F0768E] py-2 text-[16px] text-white transition-all hover:bg-pink-500 flex items-center justify-center gap-2"
                >
            ...
            {/* Kẹo hương bạc hà */}
            <div className="group overflow-hidden rounded-[16px] border-2 border-[#49C4D9] bg-[#D1ECF4] p-4 transition-all hover:shadow-lg">
              <div className="aspect-square w-full max-md:w-3/4 mx-auto">
                <img src="/huong-bac-ha.png" alt="Kẹo hương bạc hà" className="h-full w-full object-contain" />
              </div>
              <div className="mt-4 text-center">
                <h3 className="text-[20px] font-bold text-[#49C4D9]">Kẹo ngậm Kisshu<br />hương bạc hà</h3>
                <p className="mt-2 text-[14px] text-gray-600">Thưởng thức hương vị dâu tây tự nhiên, ngọt ngào và tươi mát với kẹo ngậm Kisshu hương dâu.</p>
                <button
                  onClick={() => window.open('https://shopee.vn/S%E1%BA%A3n-ph%E1%BA%A9m-m%E1%BB%9Bi-COMBO-5-K%E1%BA%B9o-Ng%E1%BA%ADm-Th%C6%A1m-Mi%E1%BB%87ng-KISSHU-%E2%80%93-B%E1%BA%A3o-Ng%E1%BB%8Dc-i.293575788.24957156660', '_blank')}
                  className="mt-4 w-full rounded-[8px] bg-[#49C4D9] py-2 text-[16px] text-white transition-all hover:bg-cyan-500 flex items-center justify-center gap-2"
                >
                  Mua ngay <img src="/shop-white.png" alt="shop" className="w-6 h-6 object-contain" />
                </button>
              </div>
            ...
            {/* Kẹo hương chanh */}
            <div className="group overflow-hidden rounded-[16px] border-2 border-[#F0C034] bg-[#F5EEC4] p-4 transition-all hover:shadow-lg">
              <div className="aspect-square w-full max-md:w-3/4 mx-auto">
                <img src="/huong-chanh.png" alt="Kẹo hương chanh" className="h-full w-full object-contain" />
              </div>
              <div className="mt-4 text-center">
                <h3 className="text-[20px] font-bold text-[#F0C034]">Kẹo ngậm Kisshu<br />hương chanh</h3>
                <p className="mt-2 text-[14px] text-gray-600">Thưởng thức hương vị dâu tây tự nhiên, ngọt ngào và tươi mát với kẹo ngậm Kisshu hương dâu.</p>
                <button
                  onClick={() => window.open('https://shopee.vn/S%E1%BA%A3n-ph%E1%BA%A9m-m%E1%BB%9Bi-COMBO-5-K%E1%BA%B9o-Ng%E1%BA%ADm-Th%C6%A1m-Mi%E1%BB%87ng-KISSHU-%E2%80%93-B%E1%BA%A3o-Ng%E1%BB%8Dc-i.293575788.24957156660', '_blank')}
                  className="mt-4 w-full rounded-[8px] bg-[#F0C034] py-2 text-[16px] text-white transition-all hover:bg-yellow-500 flex items-center justify-center gap-2"
                >
                  Mua ngay <img src="/shop-white.png" alt="shop" className="w-6 h-6 object-contain" />
                </button>
              </div>
            ...
            {/* Kẹo hương dưa hấu */}
            <div className="group overflow-hidden rounded-[16px] border-2 border-[#006352] bg-[#F9D0CF] p-4 transition-all hover:shadow-lg">
              <div className="aspect-square w-full max-md:w-3/4 mx-auto">
                <img src="/huong-dua-hau.png" alt="Kẹo hương dưa hấu" className="h-full w-full object-contain" />
              </div>
              <div className="mt-4 text-center">
                <h3 className="text-[20px] font-bold text-[#006352]">Kẹo ngậm Kisshu<br />hương dưa hấu</h3>
                <p className="mt-2 text-[14px] text-gray-600">Thưởng thức hương vị dâu tây tự nhiên, ngọt ngào và tươi mát với kẹo ngậm Kisshu hương dâu.</p>
                <button
                  onClick={() => window.open('https://shopee.vn/S%E1%BA%A3n-ph%E1%BA%A9m-m%E1%BB%9Bi-COMBO-5-K%E1%BA%B9o-Ng%E1%BA%ADm-Th%C6%A1m-Mi%E1%BB%87ng-KISSHU-%E2%80%93-B%E1%BA%A3o-Ng%E1%BB%8Dc-i.293575788.24957156660', '_blank')}
                  className="mt-4 w-full rounded-[8px] bg-[#006352] py-2 text-[16px] text-white transition-all hover:bg-green-500 flex items-center justify-center gap-2"
                >
                  Mua ngay <img src="/shop-white.png" alt="shop" className="w-6 h-6 object-contain" />
                </button>
              </div>
            ...
            {/* Kẹo vị ô mai */}
            <div className="group overflow-hidden rounded-[16px] border-2 border-[#C5272D] bg-[#F2D5BA] p-4 transition-all hover:shadow-lg">
              <div className="aspect-square w-full max-md:w-3/4 mx-auto">
                <img src="/vi-o-mai.png" alt="Kẹo vị ô mai" className="h-full w-full object-contain" />
              </div>
              <div className="mt-4 text-center">
                <h3 className="text-[20px] font-bold text-[#C5272D]">Kẹo ngậm Kisshu<br />vị ô mai</h3>
                <p className="mt-2 text-[14px] text-gray-600">Thưởng thức hương vị dâu tây tự nhiên, ngọt ngào và tươi mát với kẹo ngậm Kisshu hương dâu.</p>
                <button
                  onClick={() => window.open('https://shopee.vn/S%E1%BA%A3n-ph%E1%BA%A9m-m%E1%BB%9Bi-COMBO-5-K%E1%BA%B9o-Ng%E1%BA%ADm-Th%C6%A1m-Mi%E1%BB%87ng-KISSHU-%E2%80%93-B%E1%BA%A3o-Ng%E1%BB%8Dc-i.293575788.24957156660', '_blank')}
                  className="mt-4 w-full rounded-[8px] bg-[#C5272D] py-2 text-[16px] text-white transition-all hover:bg-red-500 flex items-center justify-center gap-2"
                >
                  Mua ngay <img src="/shop-white.png" alt="shop" className="w-6 h-6 object-contain" />
                </button>
              </div>
